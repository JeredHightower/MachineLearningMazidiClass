...
# Tune hyperparameters (tried but it wouldn't converge: reaching max number of iterations)
```{r}
tune.poly <- tune(svm, music_genre~., data=vald, kernel="polynomial", ranges = list(cost=c(.1, 1, 5, 10, 100), degree=c(3,4,5), coef.0=c(0,1,2)))
summary(tune.poly)
```
